import { useCreateNewWalletMutation, useGetWalletBalanceQuery } from '@AppleOfEnlightenment/api-react';
import { ButtonLoading, chiaToMojo, EstimatedFee, Flex, Form, mojoToChiaLocaleString } from '@AppleOfEnlightenment/core';
