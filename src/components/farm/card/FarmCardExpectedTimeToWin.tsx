import { useGetBlockchainStateQuery, useGetTotalHarvestersSummaryQuery } from '@AppleOfEnlightenment/api-react';
import { State, CardSimple } from '@AppleOfEnlightenment/core';
