import type { PlotNFT, PlotNFTExternal } from '@AppleOfEnlightenment/api';
import { useGetPoolLoginLinkQuery } from '@AppleOfEnlightenment/api-react';
import { Button, CopyToClipboard, Flex, Link, Loading } from '@AppleOfEnlightenment/core';
