import type { UnconfirmedPlotNFT } from '@AppleOfEnlightenment/api';
import { useGetTransactionQuery } from '@AppleOfEnlightenment/api-react';
import { Flex, Link, Loading } from '@AppleOfEnlightenment/core';
