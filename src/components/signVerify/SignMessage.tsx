import { toBech32m, toSnakeCase } from '@AppleOfEnlightenment/api';
import { useSignMessageByAddressMutation, useSignMessageByIdMutation } from '@AppleOfEnlightenment/api-react';
import { Button, Card, Flex, Form, TextField, useOpenDialog, useShowError } from '@AppleOfEnlightenment/core';
