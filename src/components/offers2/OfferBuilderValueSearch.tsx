import type { NFTInfo, Wallet } from '@AppleOfEnlightenment/api';
import { useGetNFTWallets } from '@AppleOfEnlightenment/api-react';
import { useDarkMode } from '@AppleOfEnlightenment/core';
