...
import { OfferSummaryRecord, OfferTradeRecord } from '@AppleOfEnlightenment/api';
import { useCheckOfferValidityMutation, useGetNFTInfoQuery, useGetNFTWallets } from '@AppleOfEnlightenment/api-react';
import {
  Back,
  Button,
  ButtonLoading,
